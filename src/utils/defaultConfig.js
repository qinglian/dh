...
export const DEFAULT_CONFIG = {
  ...
  'nav-glass-dark-bg-color': '#6366f1',
  'nav-glass-dark-bg-color-opacity': '30',
  'nav-glass-dark-bg-color-enabled': 'false',
  ...
  'nav-glass-light-bg-color': '#6366f1',
  'nav-glass-light-bg-color-opacity': '30',
  'nav-glass-light-bg-color-enabled': 'false',
